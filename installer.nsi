...
Function .onInit
    ...
    StrCpy $backupSize 2885156864 ; 2.68 GB, everything up to /contents + 400 Mb including fat32 headers and CFW directory, see /proc/dumchar_info
FunctionEnd
...
Section reviewPageLeave
    ...
    DetailPrint "Checking for driver"
    nsExec::ExecToLog '$R7 /C "pnputil /enum-drivers"'
    DetailPrint '$R7 /C "pnputil /enum-drivers | findstr /i "VID_0E8D&PID_2000 ^(libwdi autogenerated^)""'
    nsExec::ExecToLog '$R7 /C "pnputil /enum-drivers | findstr /i "VID_0E8D&PID_2000 ^(libwdi autogenerated^)""'
    ...
    StrCmp $foundCode "0" found
        ...
        DetailPrint "Driver installed (code $foundCode)"
        goto done
    found:
        DetailPrint "Driver already installed (code $foundCode)"
    done:
